...
#import "NWStatusBarView.h"

/**
 *  A block that is used to define the appearance of a notification.
 *  A NWStatusBarStyle instance defines the notification appeareance.
 *
 *  @param style The current default NWStatusBarStyle instance.
 *
 *  @return The modified NWStatusBarStyle instance.
 */
typedef NWStatusBarStyle*(^NWPrepareStyleBlock)(NWStatusBarStyle *style);


@interface NWStatusBarNotification : NSObject
 ...
 */
+ (NWStatusBarView*)showWithStatus:(NSString *)status;
 ...
 *
 *  @param status The message to display
 *  @param styleName The name of the style. You can use any NWStatusBarStyle constant
 *  (NWStatusBarStyleDefault, etc.), or a custom style identifier, after you added a
 ...
 *
 *  @param prepareBlock A block, which has a NWStatusBarStyle instance as
