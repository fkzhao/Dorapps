...
@interface NWScrollView : UIScrollView
@end

@interface NWSegmentedControl ()
...
@property (nonatomic, strong) NWScrollView *scrollView;

@end

@implementation NWScrollView
...
@implementation NWSegmentedControl
...
- (id)initWithSectionTitles:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.type = NWSegmentedControlTypeText;
    }
...
- (id)initWithSectionImages:(NSArray*)sectionImages sectionSelectedImages:(NSArray*)sectionSelectedImages {
    ...
    if (self) {
        ...
        self.type = NWSegmentedControlTypeImages;
    }
...
- (instancetype)initWithSectionImages:(NSArray *)sectionImages sectionSelectedImages:(NSArray *)sectionSelectedImages titlesForSections:(NSArray *)sectiontitles {
    ...
    if (self) {
        ...
        self.sectionSelectedImages = sectionSelectedImages;
		self.sectionTitles = sectiontitles;
        self.type = NWSegmentedControlTypeTextImages;
    }
...
- (void)commonInit {
    self.scrollView = [[NWScrollView alloc] init];
    ...
    self.textColor = [UIColor colorWithWhite:0 alpha:0.6];
    self.selectedTextColor = [UIColor colorWithWhite:0 alpha:0.6];
    ...
    self.selectionStyle = NWSegmentedControlSelectionStyleTextWidthStripe;
    self.selectionIndicatorLocation = NWSegmentedControlSelectionIndicatorLocationUp;
    self.segmentWidthStyle = NWSegmentedControlSegmentWidthStyleFixed;
...
- (void)setSelectionIndicatorLocation:(NWSegmentedControlSelectionIndicatorLocation)selectionIndicatorLocation {
	_selectionIndicatorLocation = selectionIndicatorLocation;
	
	if (selectionIndicatorLocation == NWSegmentedControlSelectionIndicatorLocationNone) {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == NWSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight)/2 - stringHeight/2 + ((self.selectionIndicatorLocation == NWSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
            
            CGRect rect;
            if (self.segmentWidthStyle == NWSegmentedControlSegmentWidthStyleFixed) {
                rect = CGRectMake((self.segmentWidth * idx) + (self.segmentWidth - stringWidth)/2, y, stringWidth, stringHeight);
            } else if (self.segmentWidthStyle == NWSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == NWSegmentedControlTypeImages) {
        [self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            UIImage *icon = iconImage;
            CGFloat imageWidth = icon.size.width;
            CGFloat imageHeight = icon.size.height;
            CGFloat y = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2 - imageHeight / 2 + ((self.selectionIndicatorLocation == NWSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
    ...
    } else if (self.type == NWSegmentedControlTypeTextImages){
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            CGFloat yOffset = roundf(CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2 - stringHeight / 2 + ((self.selectionIndicatorLocation == NWSegmentedControlSelectionIndicatorLocationUp) ? self.selectionIndicatorHeight : 0);
    ...
    if (self.selectedSegmentIndex != NWSegmentedControlNoSegment) {
        if (self.selectionStyle == NWSegmentedControlSelectionStyleArrow) {
            ...
            if (!self.selectionIndicatorStripLayer.superlayer) {
                ...
                if (self.selectionStyle == NWSegmentedControlSelectionStyleBox && !self.selectionIndicatorBoxLayer.superlayer) {
...
- (void)setArrowFrame {
    ...
    if (self.selectionIndicatorLocation == NWSegmentedControlSelectionIndicatorLocationDown) {
    ...
    if (self.selectionIndicatorLocation == NWSegmentedControlSelectionIndicatorLocationUp) {
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == NWSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == NWSegmentedControlSelectionStyleTextWidthStripe &&
            sectionWidth <= self.segmentWidth &&
            self.segmentWidthStyle != NWSegmentedControlSegmentWidthStyleDynamic) {
            CGFloat widthToEndOfSelectedSegment = (self.segmentWidth * self.selectedSegmentIndex) + self.segmentWidth;
            CGFloat widthToStartOfSelectedIndex = (self.segmentWidth * self.selectedSegmentIndex);
            ...
            if (self.segmentWidthStyle == NWSegmentedControlSegmentWidthStyleDynamic) {
...
- (void)updateSegmentsRects {
    ...
    if (self.type == NWSegmentedControlTypeText && self.segmentWidthStyle == NWSegmentedControlSegmentWidthStyleFixed) {
    ...
    } else if (self.type == NWSegmentedControlTypeText && self.segmentWidthStyle == NWSegmentedControlSegmentWidthStyleDynamic) {
    ...
    } else if (self.type == NWSegmentedControlTypeTextImages && NWSegmentedControlSegmentWidthStyleFixed){
    ...
    } else if (self.type == NWSegmentedControlTypeTextImages && NWSegmentedControlSegmentWidthStyleDynamic) {
        NSMutableArray *mutableSegmentWidths = [NSMutableArray array];
...
- (void)setSelectedSegmentIndex:(NSUInteger)index animated:(BOOL)animated notify:(BOOL)notify {
    ...
    if (index == NWSegmentedControlNoSegment) {
        ...
        if (animated) {
            ...
            if(self.selectionStyle == NWSegmentedControlSelectionStyleArrow) {
                ...
                if ([self.selectionIndicatorStripLayer superlayer] == nil) {
                    ...
                    if (self.selectionStyle == NWSegmentedControlSelectionStyleBox && [self.selectionIndicatorBoxLayer superlayer] == nil)
                        [self.scrollView.layer insertSublayer:self.selectionIndicatorBoxLayer atIndex:0];
