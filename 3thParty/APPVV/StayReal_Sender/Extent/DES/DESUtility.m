...
static NSString *_key = DES_KEYWORLD;
...
+ (NSString *) udid
{
    return @"uuid";//[DESUtility encryptStr:[[UIDevice currentDevice] uniqueIdentifier]];
}
...
+ (NSString *)doCipher:(NSString *)sTextIn key:(NSString *)sKey
    ...
    if (encryptOrDecrypt == kCCDecrypt){
        ...
        sResult = [DESUtility encodeBase64WithData:dResult];
    }
    return sResult;
}
...
+(NSString*) decryptUseDES:(NSString*)cipherText{
    return [DESUtility decryptUseDES:cipherText key:_key];
}
...
+(NSString *) encryptUseDES:(NSString *)clearText{
    return [DESUtility encryptUseDES:clearText key:_key];
}
